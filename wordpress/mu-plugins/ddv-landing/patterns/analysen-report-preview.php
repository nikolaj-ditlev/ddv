...
<!-- wp:group {"className":"ddv-section","backgroundColor":"ddv-cream"} -->
...
<figure class="wp-block-image size-large ddv-rounded-image"><img src="https://ddv.org/wp-content/uploads/2026/08/ddv-analysen-rapport-pyramide.png" alt="Mockup af DDV rapport med modenhedspyramide"/></figure>
<!-- /wp:image -->
</div>
<!-- /wp:column -->
