...
<p class="ddv-eyebrow has-ddv-white-color has-text-color">Gratis – uden login</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"className":"ddv-eyebrow","textColor":"ddv-white"} -->
<p class="ddv-eyebrow has-ddv-white-color has-text-color">30 min. i alt</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->

<!-- wp:heading {"level":1,"textColor":"ddv-white","fontSize":"x-large"} -->
<h1 class="wp-block-heading has-ddv-white-color has-text-color has-x-large-font-size">DDV Analysen giver jer svarene på jeres vedligeholdsniveau</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"ddv-white"} -->
<p class="has-ddv-white-color has-text-color">Få en uvildig vurdering af jeres vedligeholdsniveau på 26 trin – og se præcis hvor I står stærkt, og hvor I mister penge.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"className":"ddv-hero-trust","textColor":"ddv-white","fontSize":"small"} -->
<p class="ddv-hero-trust has-ddv-white-color has-text-color has-small-font-size">Ingen kreditkort · Resultat med det samme · PDF til ledergruppen</p>
<!-- /wp:paragraph -->
